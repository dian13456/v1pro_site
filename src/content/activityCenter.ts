...
export const ACTIVITIES: ActivityItem[] = [
  ...
  },
  {
    id: "like-reward",
    title: "点赞得积分",
    summary: "点赞双方均可获得积分：上传者 +1，点赞者 +0.5（每日上限 10）。",
    body: "在素材中心浏览并点赞他人作品时：上传者获得 1 积分（取消点赞不扣回，再次点赞不重复发放）；点赞者获得 0.5 积分，每日最多 10 积分。素材被他人有效下载时，上传者再获得 0.5 积分，每日最多 20 积分（同一下载者对同一素材每天仅计 1 次，自下载不计）。积分可在积分商城兑换 V1PRO CNC 喵喵壳子 77 帧兑换码等权益。不能给自己的素材点赞或下载得分。",
    status: "ongoing",
    category: "reward",
