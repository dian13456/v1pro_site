...
export const ACTIVITIES: ActivityItem[] = [
  {
    ...
    title: "新上福利活动（二选一）",
    summary: "CNC 复购加送注塑 V1PRO，或参与视频点赞免单，只能选一个。",
    body: "活动一：原有 CNC 用户，复购注塑 V1PRO，凭订单号加送一个注塑 V1PRO。资料填写 CNC 订单号（直购用户发支付截图）、订单截图、注塑 V1PRO 颜色备注和收货地址，审核通过后安排加送发货。活动二：视频点赞免单，需提交订单号、订单截图、视频链接与收款码。两个活动只能二选一参与，提交后不可更改。",
    status: "ongoing",
    category: "reward",
  ...
  },
  {
    ...
    body: "购买 V1PRO 设备即可使用 SN 编号报名参与抽奖。每天 0:00 报名信息刷新，前一天报名记录清零；每天晚上 7:00 自动开奖。每个 SN 每天可报名一次，一个 SN 仅可获得一次中奖资格。中奖后请填写收货地址与 QQ 号，我们将安排发货。",
    status: "ongoing",
    category: "reward",
  ...
  },
  {
    id: "like-reward",
    title: "点赞得积分",
    summary: "他人为你的上传素材点赞，你可获得积分奖励。",
    body: "在素材中心浏览并点赞他人作品，被点赞的上传者将获得积分。积分可在积分商城兑换 V1PRO CNC 喵喵壳子 77 帧兑换码等权益。不能给自己的素材点赞得分。",
    status: "ongoing",
    category: "reward",
