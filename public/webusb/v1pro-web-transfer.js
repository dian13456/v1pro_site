 ...
 */
import { DEFAULT_MAX_GIF_FRAMES, WEBUSB_TRANSFER_VERSION } from "./v1pro-constants.js?v=1.0.2";
import { encodeBlobToGfm1 } from "./v1pro-gfm1.js?v=1.0.2";
import {
  closeDevice,
